...
#             # F_u /rho
#             row[cmpt]=Fu_idx(j,n,Nt,Nx); col[cmpt]=r_idx(j,n,Nt); 
#             data[cmpt]=-f_starp_r((w[V_idx(r,n+1,Nt,Nx)]-w[V_idx(l,n+1,Nt,Nx)])/(2*dx),w[r_idx(j,n,Nt)])
#             cmpt +=1
#             # F_u / u
#             row[cmpt]=Fu_idx(j,n,Nt,Nx); col[cmpt]=u_idx(j,n,Nt,Nx); data[cmpt]=1
#             cmpt +=1
#             # F_u / V
#             row[cmpt]=Fu_idx(j,n,Nt,Nx); col[cmpt]=V_idx(r,n+1,Nt,Nx); 
#             data[cmpt]=-(1/(2*dx))*f_starp_p((w[V_idx(r,n+1,Nt,Nx)]-w[V_idx(l,n+1,Nt,Nx)])/(2*dx),w[r_idx(j,n,Nt)])
#             cmpt +=1
#             row[cmpt]=Fu_idx(j,n,Nt,Nx); col[cmpt]=V_idx(l,n+1,Nt,Nx); 
#             data[cmpt]=(1/(2*dx))*f_starp_p((w[V_idx(r,n+1,Nt,Nx)]-w[V_idx(l,n+1,Nt,Nx)])/(2*dx),w[r_idx(j,n,Nt)])
#             cmpt +=1
#             # F_V / rho
#             row[cmpt]=FV_idx(j,n,Nt,Nx); col[cmpt]=r_idx(j,n,Nt); 
#             data[cmpt]=f_star_r((w[V_idx(r,n+1,Nt,Nx)]-w[V_idx(l,n+1,Nt,Nx)])/(2*dx),w[r_idx(j,n,Nt)])
#             cmpt +=1
#             # F_V / V
#             row[cmpt]=FV_idx(j,n,Nt,Nx); col[cmpt]=V_idx(j,n,Nt,Nx); data[cmpt]=-1/dt
#             cmpt +=1
#             row[cmpt]=FV_idx(j,n,Nt,Nx); col[cmpt]=V_idx(l,n+1,Nt,Nx); 
#             data[cmpt]=eps-(1/(2*dx))*f_star_p((w[V_idx(r,n+1,Nt,Nx)]-w[V_idx(l,n+1,Nt,Nx)])/(2*dx),w[r_idx(j,n,Nt)])
#             cmpt +=1
