...
# mu=0.045 # Sep viscosity coefficient 
...
t0 = time.process_time()   ###
sol0 = newton_krylov(F, guess0, method='gmres', verbose=0, inner_M=prec)
# sol1=np.loadtxt('PL_Sol0_LWR_T3_N1.dat')
# assert(sol0==sol1).all()
t1 = time.process_time()   ###
time2=t1-t0
print("Time spent (gmres) :",time2)
cpu_time=time1+time2
print("CPU time :",cpu_time)
np.savetxt('plots/lwr/Seq_Sol0_LWR_T3_N1.dat', sol0)
# np.savetxt('plots/sep/Seq_Sol0_Sep_T3_N1.dat', sol0)
# np.savetxt('plots/nonsep/Seq_Sol0_NonSep_T3_N1.dat', sol0)

""" solve in finer grid 1 """
# Nx=15; Nt=60
# mu=0.03 # Sep viscosity coefficient 
# mu=0.03 # NonSep viscosity coefficient
# sol0=np.loadtxt('plots/sep/Seq_Sol0_Sep_T3_N1.dat')
# sol0=np.loadtxt('plots/nonsep/Seq_Sol0_NonSep_T3_N1.dat')
Nxx=2*Nx; Ntt=2*Nt
...
np.savetxt('plots/lwr/Seq_Guess1_LWR_T3_N1.dat', guess1)
# np.savetxt('plots/sep/Seq_Guess1_Sep_T3_N1.dat', guess1)
# np.savetxt('plots/nonsep/Seq_Guess1_NonSep_T3_N1.dat', guess1)
Nx=2*Nx; Nt=2*Nt
print('Nx={Nx}, Nt={Nt}'.format(Nx=Nx,Nt=Nt))
...
print("Time spent (anal_precond) :",time1)
t0 = time.process_time()   ###
sol1 = newton_krylov(F, guess1, method='gmres', verbose=0, inner_M=prec)
t1 = time.process_time()   ###
time2=t1-t0
print("Time spent (gmres) :",time2)
cpu_time=time1+time2
print("CPU time :",cpu_time)
np.savetxt('plots/lwr/Seq_Sol1_LWR_T3_N1.dat', sol1)
# np.savetxt('plots/sep/Seq_Sol1_Sep_T3_N1.dat', sol1)
# np.savetxt('plots/nonsep/Seq_Sol1_NonSep_T3_N1.dat', sol1)

""" solve in finer grid 2 """
# Nx=30; Nt=180
# mu=0.02 # Sep viscosity coefficient 
# mu=0.03 # NonSep viscosity coefficient
# sol1=np.loadtxt('plots/sep/Seq_Sol1_Sep_T3_N1.dat')
# sol1=np.loadtxt('plots/nonsep/Seq_Sol1_NonSep_T3_N1.dat')
Nxx=2*Nx; Ntt=2*Nt
dx=L/Nxx # spatial step size
if mu==0.0:
    dt=min(T/Nt,(CFL*dx)/u_max) # temporal step size
...
t1 = time.process_time()   ###
print("Time spent (multigrid) :",t1-t0)
np.savetxt('plots/lwr/Seq_Guess2_LWR_T3_N1.dat', guess2)
# np.savetxt('plots/sep/Seq_Guess2_Sep_T3_N1.dat', guess2)
# np.savetxt('plots/nonsep/Seq_Guess2_NonSep_T3_N1.dat', guess2)
Nx=2*Nx; Nt=2*Nt
print('Nx={Nx}, Nt={Nt}'.format(Nx=Nx,Nt=Nt))
print('dx={dx}, dt={dt}'.format(dx=round(dx,3),dt=round(dt,3)))
t0 = time.process_time()   ###
...
print("Time spent (anal_precond) :",time1)
t0 = time.process_time()   ###
sol2 = newton_krylov(F, guess2, method='gmres', verbose=0, inner_M=prec)
t1 = time.process_time()   ###
time2=t1-t0
print("Time spent (gmres) :",time2)
cpu_time=time1+time2
print("CPU time :",cpu_time)
np.savetxt('plots/lwr/Seq_Sol2_LWR_T3_N1.dat', sol2)
# np.savetxt('plots/sep/Seq_Sol2_Sep_T3_N1.dat', sol2)
# np.savetxt('plots/nonsep/Seq_Sol2_NonSep_T3_N1.dat', sol2)

""" solve in finer grid 3 """
# Nx=60; Nt=720
# mu=0.02 # Sep viscosity coefficient 
# mu=0.03 # NonSep viscosity coefficient
# # sol2=np.loadtxt('plots/lwr/Seq_Sol2_LWR_T3_N1.dat')
# sol2=np.loadtxt('plots/sep/Seq_Sol2_Sep_T3_N1.dat')
# sol2=np.loadtxt('plots/nonsep/Seq_Sol2_NonSep_T3_N1.dat')
Nxx=2*Nx; Ntt=2*Nt
dx=L/Nxx # spatial step size
if mu==0.0:
    dt=min(T/Nt,(CFL*dx)/u_max) # temporal step size
...
t1 = time.process_time()   ###
print("Time spent (multigrid) :",t1-t0)
np.savetxt('plots/lwr/Seq_Guess3_LWR_T3_N1.dat', guess3)
# np.savetxt('plots/sep/Seq_Guess3_Sep_T3_N1.dat', guess3)
# np.savetxt('plots/nonsep/Seq_Guess3_NonSep_T3_N1.dat', guess3)
Nx=2*Nx; Nt=2*Nt
print('Nx={Nx}, Nt={Nt}'.format(Nx=Nx,Nt=Nt))
print('dx={dx}, dt={dt}'.format(dx=round(dx,3),dt=round(dt,3)))
t0 = time.process_time()   ###
...
print("Time spent (anal_precond) :",time1)
t0 = time.process_time()   ###
sol3 = newton_krylov(F, guess3, method='gmres', verbose=0, inner_M=prec)
t1 = time.process_time()   ###
time2=t1-t0
print("Time spent (gmres) :",time2)
cpu_time=time1+time2
print("CPU time :",cpu_time)
np.savetxt('plots/lwr/Seq_Sol3_LWR_T3_N1.dat', sol3)
# np.savetxt('plots/sep/Seq_Sol3_Sep_T3_N1.dat', sol3)
# np.savetxt('plots/nonsep/Seq_Sol3_NonSep_T3_N1.dat', sol3)

""" solve in finer grid 4 """
# Nx=120; Nt=1920
# mu=0.02 # Sep viscosity coefficient
# mu=0.01 # NonSep viscosity coefficient
# # sol3=np.loadtxt('plots/Seq_Sol3_LWR_T3_N1.dat')
# sol3=np.loadtxt('plots/sep/Seq_Sol3_Sep_T3_N1.dat')
# # sol3=np.loadtxt('plots/nonsep/Seq_Sol3_NonSep_T3_N1.dat')
Nxx=2*Nx; Ntt=2*Nt
dx=L/Nxx # spatial step size
if mu==0.0:
...
t1 = time.process_time()   ###
print("Time spent (multigrid) :",t1-t0)
np.savetxt('plots/lwr/Seq_Guess4_LWR_T3_N1.dat', guess4)
# np.savetxt('plots/sep/Seq_Guess4_Sep_T3_N1.dat', guess4)
# np.savetxt('plots/nonsep/Seq_Guess4_NonSep_T3_N1.dat', guess4)
Nx=2*Nx; Nt=2*Nt
print('Nx={Nx}, Nt={Nt}'.format(Nx=Nx,Nt=Nt))
print('dx={dx}, dt={dt}'.format(dx=round(dx,3),dt=round(dt,3)))
t0 = time.process_time()   ###
...
print("Time spent (anal_precond) :",time1)
t0 = time.process_time()   ###
sol4 = newton_krylov(F, guess4, method='gmres', verbose=0, inner_M=prec)
t1 = time.process_time()   ###
time2=t1-t0
print("Time spent (gmres) :",time2)
cpu_time=time1+time2
print("CPU time :",cpu_time)
np.savetxt('plots/lwr/Seq_Sol4_LWR_T3_N1.dat', sol4)
# np.savetxt('plots/sep/Seq_Sol4_Sep_T3_N1.dat', sol4)
# np.savetxt('plots/nonsep/Seq_Sol4_NonSep_T3_N1.dat', sol4)

""" solve in finer grid 5 """
# Nx=240; Nt=960
# sol4=np.loadtxt('plots/lwr/Seq_Sol4_LWR_T3_N1.dat')
# sol4=np.loadtxt('plots/sep/Seq_Sol4_Sep_T3_N1.dat')
# sol4=np.loadtxt('plots/nonsep/Seq_Sol4_NonSep_T3_N1.dat')
Nxx=2*Nx; Ntt=2*Nt
dx=L/Nxx # spatial step size
if mu==0.0:
    dt=min(T/Ntt,(CFL*dx)/u_max) # temporal step size
...
Nt=int((len(t)-1)/2)
t0 = time.process_time()   ###
guess5=multigrid(int(Ntt/2),Nt,sol4)
t1 = time.process_time()   ###
print("Time spent (multigrid) :",t1-t0)
np.savetxt('plots/lwr/Seq_Guess5_LWR_T3_N1.dat', guess5)
# np.savetxt('plots/sep/Seq_Guess5_Sep_T3_N1.dat', guess5)
# np.savetxt('plots/nonsep/Seq_Guess5_NonSep_T3_N1.dat', guess5)
Nx=2*Nx; Nt=2*Nt
print('Nx={Nx}, Nt={Nt}'.format(Nx=Nx,Nt=Nt))
print('dx={dx}, dt={dt}'.format(dx=round(dx,3),dt=round(dt,3)))
t0 = time.process_time()   ###
prec=get_preconditioner(guess5)
t1 = time.process_time()   ###
time1=t1-t0
print("Time spent (anal_precond) :",time1)
t0 = time.process_time()   ###
sol5 = newton_krylov(F, guess5, method='gmres', verbose=0, inner_M=prec)
t1 = time.process_time()   ###
time2=t1-t0
print("Time spent (gmres) :",time2)
cpu_time=time1+time2
print("CPU time :",cpu_time)
np.savetxt('plots/lwr/Seq_Sol5_LWR_T3_N1.dat', sol5)
# np.savetxt('plots/sep/Seq_Sol5_Sep_T3_N1.dat', sol5)
# np.savetxt('plots/nonsep/Seq_Sol5_NonSep_T3_N1.dat', sol5)
